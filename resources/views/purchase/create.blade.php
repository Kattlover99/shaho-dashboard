			...
			<div class="row">
				<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select('contact_id', $suppliers, null , ['class' => 'form-control', 'id' => 'supplier_id', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'required']); !!}
				...
				<div class="col-sm-3">
					<div class="form-group">
                        ...
                        {!! Form::select('location_id', $business_locations, $default_location, ['class' => 'form-control select2 input-sm',
				...
				{!! Form::hidden('location_id_type', $default_location, ['id' => 'location_id_type', 'data-receipt_printer_type' => isset($bl_attributes[$default_location]['data-receipt_printer_type']) ? $bl_attributes[$default_location]['data-receipt_printer_type'] : 'browser']); !!}
	...
	<div class="box box-solid"><!--box start-->
		...
		<div class="col-sm-10 col-sm-offset-1">
				<div class="form-group">
					...
					<select class="form-control select2 input-sm" id="available_product_list" name="available_product_list" required>
					    <option selected="selected" value="">Select Product</option>
                        @foreach ($available_product_list as $user)
                            <option data-product-id="{{ $user['product_id'] }}" data-variation-id="{{ $user['variation_id'] }}">{{ $user['text'] }}</option>
                        @endforeach
					</select>
					</div>
				</div>
...
<div class="modal fade contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
	@include('contact.create', ['quick_add' => true, 'contactCategory' => $contactCategory])
</div>
<!-- /.content -->
@endsection
