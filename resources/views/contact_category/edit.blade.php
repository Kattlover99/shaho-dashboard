<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('ContactCategoryController@update', [$category->id]), 'method' => 'PUT', 'id' => 'contact_category_edit_form' ]) !!}
	...
	<div class="form-group">
        {!! Form::label('description', __( 'Description' ) . ':*') !!}
          {!! Form::text('description', $category->description, ['class' => 'form-control', 'required', 'placeholder' => __( 'Description' )]); !!}
      </div>
