<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('ContactCategoryController@store'), 'method' => 'post', 'id' => 'contact_category_add_form' ]) !!}
    ...
    <div class="modal-body">
      <div class="form-group">
        ...
        {!! Form::label('description', __( 'Description' ) . ':*') !!}
          {!! Form::text('description', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'Description' )]); !!}
      </div>
