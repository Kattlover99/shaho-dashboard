                ...
                {!! Form::select('contact_id', $customers, null , ['class' => 'form-control', 'id' => 'contact_id', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'required']); !!}
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							{!! Form::select('invoice_type', ['cash' => __('sale.cash'), 'debit' => __('sale.debit')], 'cash', ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
						</div>
					</div>
				</div>
				<!-- /.box-body -->
						...
						<div class="form-group">
							<div class="input-group">
								...
								{!! Form::select('available_product_list',
									...
									<input type="hidden" id="auto_load_products" value="0" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-4">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::select('discount_type', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], 'percentage' , ['class' => 'form-control','placeholder' => __('messages.please_select'), 'data-default' => 'percentage']); !!}
				            </div>
				        </div>
				    </div>
				    <div class="col-md-4">
