...
<!--{!! Form::select('contact_id', $contacts, $transaction->contact->id, ['class' => 'form-control mousetrap', 'id' => 'customer_id', 'placeholder' => 'Enter Customer name / phone', 'required']); !!}-->
{!! Form::select('contact_id', $contacts, $transaction->contact->id , ['class' => 'form-control', 'id' => 'customer_id', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'required']); !!}
					...
					<div class="col-sm-4">
						<div class="form-group">
							{!! Form::label('invoice_type', __('sale.invoice_type') . ':*') !!}
							{!! Form::select('invoice_type', ['cash' => __('sale.cash'), 'debit' => __('sale.debit')], $transaction->invoice_type, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
						</div>
					</div>
				</div>
				<!-- /.box-body -->
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="hidden" id="auto_load_products" value="1" />
							</div>
						</div>
