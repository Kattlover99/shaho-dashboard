        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="well well-sm">
                                ...
                                <p class="text-muted">
                                <strong>@lang('Category'):</strong> {{ $contact->category }}
                                </p>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-default full-width customer_statement_report"><b>Customer Statement Report</b></button>
                            <br>
                            <br>
                            <button type="button" class="btn btn-default full-width customer_add_payment_modal"><b>Add Payment</b></button>
                        </div>
                ...
                <div class="col-sm-6">
                    ...
                    @if( $contact->type == 'customer' || $contact->type == 'both')
                        ...
                        <strong>Old Debit</strong>
                        <p class="text-muted">
                        <span class="display_currency" data-currency_symbol="true">
                            @if(!empty($contact->opening_balance)) {{ $contact->opening_balance }}
                            @else {{ 0 }}
                            @endif
                        </span>
                        </p>
                    ...
                    @if(!empty($contact->opening_balance) && $contact->opening_balance != '0.00')
                       ...
                       -->
                        <strong>@lang('lang_v1.total_debit')</strong> 
                        <p class="text-muted"> 
                        <span class="display_currency" data-currency_symbol="true"> 
                        {{ ($contact->opening_balance + ($contact->total_invoice - $contact->invoice_received)) }}</span> 
                        </p>
...
$(document).ready( function(){
    // $(".customer_add_payment_modal").click(function() {
    //     $.ajax({
    //         url: $(this).attr("href"),
    //         dataType: "html",
