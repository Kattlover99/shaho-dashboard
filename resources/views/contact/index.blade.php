            	...
            	<table class="table table-bordered table-striped" id="contact_table">
            		<thead>
            			<tr>
							...
							<!--<th>Category</th>-->
							<!-- <th>@lang('lang_v1.past_debit')</th> -->
                            <th>@lang('contact.debit_due_iqd')</th>
                            <th>@lang('contact.debit_due_usd')</th>
                    ...
                    <tr class="bg-gray font-17 footer-total text-center">
                        ...
                        <td> </td>
                        <td> </td>
                        <td >@lang('contact.total_debit_due_iqd')<span class="totalAmountInIQD"></span></td>
                        <td >@lang('contact.total_debit_due_usd')<span class="totalAmountInUSD"></span></td>
                        <td> </td>
                    </tr>
                    </tfoot>
            	</table>
