<div class="modal-dialog modal-lg abugosia" role="document">
  <div class="modal-content">
    @php
        $form_id = 'add_payment_form';
	...
	<div class="row">
      ...
      <!-- <div class="col-md-3">
          <div class="form-group">
              ...
              {!! Form::text('debit_in_iqd', 0, ['class' => 'form-control input_number']); !!}
              </div>
          </div>
      </div>
      <div class="col-md-3">
          <div class="form-group">
              ...
              {!! Form::text('debit_in_usd', 0, ['class' => 'form-control input_number']); !!}
              </div>
          </div>
      </div> -->
