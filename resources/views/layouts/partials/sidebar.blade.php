        ...
        @if(auth()->user()->can('sell.view') || auth()->user()->can('sell.create') || auth()->user()->can('direct_sell.access') )
            ...
            <i class="fa fa-angle-left pull-right"></i>
                  ...
                  <ul class="treeview-menu">
					  ...
					  @can('exire_view')
						<li class="{{ $request->segment(1) == 'expire' ? 'active' : '' }}">
						  <a href="/expire">
							<i class="fa fa-dashboard"></i> <span>
							Expire</span>
						  </a>
                  ...
                  <ul class="treeview-menu">
                      ...
                      @endcan
					   ...
					   @can('contact_category_view')
                          <li class="{{ $request->segment(1) == 'contact-categories' ? 'active' : '' }}"><a href="{{action('ContactCategoryController@index')}}"><i class="fa fa-star"></i> Category</a></li>
                      @endcan
