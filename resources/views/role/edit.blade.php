      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
		  ...
		  <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'profit_coulmn_read.access', in_array('profit_coulmn_read.access', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.profit_column_read.access' ) }}
              </label>
            </div>
          </div>
        </div>
	...
	<div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'exire_view', in_array('exire_view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'exire_add', in_array('exire_add', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Add' ) }}
              </label>
            </div>
          </div>
		  <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'exire_update', in_array('exire_update', $role_permissions), 
		  ...
		  <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'exire_delete', in_array('exire_delete', $role_permissions), 
	...
	<div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'contact_category_view', in_array('contact_category_view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'View' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'contact_category_add', in_array('contact_category_add', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Add' ) }}
              </label>
            </div>
          </div>
		  <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'contact_category_update', in_array('contact_category_update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Update' ) }}
              </label>
            </div>
          </div>
		  <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'contact_category_delete', in_array('contact_category_delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Delete' ) }}
              </label>
            </div>
          </div>
