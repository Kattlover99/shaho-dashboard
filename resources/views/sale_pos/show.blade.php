        ...
        <div class="table-responsive">
          <table class="table bg-gray">
            ...
            <tr>
              <th>Old Debit:</th>
              <td></td>
              @if(!empty($contact_for_sell->opening_balance) && $contact_for_sell->opening_balance != '0.00')
                <td><span class="display_currency pull-right" data-currency_symbol="true" >{{ $contact_for_sell->opening_balance }}</span></td>
              @else
                <td><span class="display_currency pull-right" data-currency_symbol="true" >0</span></td>
              @endif
            </tr>
            <tr>
              <th>Total Debit:</th>
              ...
              <td><span class="display_currency pull-right" data-currency_symbol="true" >
                @if( ($total_paid - $contact_for_sell->opening_balance - $sell->final_total) > 0 )
                  0
                @else
                  {{ abs($total_paid - $contact_for_sell->opening_balance - $sell->final_total) }}
                @endif
              </span></td>
            </tr>
          </table>
