	...
	<div class="col-xs-12 text-center">
		...
		<p style="width: 100% !important" >
			<span class="pull-left text-left word-wrap">
				...
				@endif
				{{ date("d-m-Y", strtotime($receipt_details->invoice_date)) }} &nbsp;
					<br>
				<!-- customer info -->
		...
		<table class="table table-responsive">
			<thead>
				<tr>
					...
					<?php if ($column_manage =='price_show'):?>
			...
			<div class="table-responsive">
				<table class="table table-condensed">
					<tbody>
						...
						<!-- Grand Total -->
						<tr>
							<th style="width: 50%; background-color: #357ca5 !important; color: red !important;font-size:18px;" class="padding-10">
								@lang('lang_v1.grand_total')
							</th>
							<td class="text-left  padding-10" style="width: 50%; background-color: #357ca5 !important; color: red !important;font-size:18px;">
								{{ $customer_balance }}
							</td>
						</tr>
