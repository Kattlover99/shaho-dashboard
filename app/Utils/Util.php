...
class Util
{
    ...
    {
        $payment_types = ['cash' => __('lang_v1.cash'), 'card' => __('lang_v1.card'), 'cheque' => __('lang_v1.cheque'), 'bank_transfer' => __('lang_v1.bank_transfer'), 'other' => __('lang_v1.other'), 'IQD' => 'IQD', 'USD' => 'USD'];

        // $payment_types = ['IQD' => 'IQD', 'USD' => 'USD'];
