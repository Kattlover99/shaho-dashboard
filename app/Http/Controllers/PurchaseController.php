...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($purchases)
                ...
                ->rawColumns(['final_total', 'action', 'payment_due', 'payment_status'])
                ->make(true);
        }
        //return view('purchase.index')->with(compact('purchase_status', 'payment_status', 'locations'));
        return view('purchase.index')->with(compact('payment_status', 'locations'));
    }
    ...
    public function create()
    {
		...
		$available_product_list = $this->getProducts_purchase();
		/*echo '<pre>';
		echo 'available_product_list<br/>';
		print_r($available_product_list);
		echo '</pre>';
		die();*/
		
        return view ('purchase.create')
            ->with(compact('taxes', 'orderStatuses', 'business_locations', 'banks', 'currency_details', 'default_purchase_status', 'customer_groups', 'types', 'shortcuts', 'payment_line', 'payment_types', 'currencies', 'default_currency_id', 'default_currency_rate', 'contactCategory', 'suppliers', 'default_location', 'bl_attributes', 'available_product_list'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function getProducts_purchase()
    {
            ...
            foreach ($products as $product) {
                ...
                $products_array[$product->product_id]['product_code'] = $product->product_code;
