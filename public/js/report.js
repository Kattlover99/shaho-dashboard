$(document).ready( function(){
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        "fnDrawCallback": function (oSettings) {
			...
			$('#footer_sale_qty').html(sum_table_col($('#product_purchase_report_table'), 'purchase_qty_sum'));
    ...
    product_sell_report = $('table#product_sell_report_table').DataTable({
        ...
        "fnDrawCallback": function (oSettings) {
			$('#footer_sale_qty').html(sum_table_col($('#product_sell_report_table'), 'purchase_qty_sum'));
...
function updateProfitLoss(){
    ...
    var data = { start_date: start, end_date: end, location_id: location_id, category:category  };
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('.total_adjustment').html(__currency_trans_from_en( data.total_expire, true ));
            $('.total_recovered').html(__currency_trans_from_en( data.total_recovered, true ));
