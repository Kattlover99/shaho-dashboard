$(document).ready( function(){
    ...
    if($( "#search_product" ).length > 0){
        $( "#search_product" ).autocomplete({
            ...
            select: function( event, ui ) {
                ...
                console.log('ui.item.product_id: '+ui.item.product_id);
                console.log('ui.item.variation_id :'+ui.item.variation_id);
    ...
    {
        var product_id = $('#available_product_list option:selected').data('product-id');
        var variation_id = $('#available_product_list option:selected').data('variation-id');
    ...
    $('select#location_idX').change(function()
    {
        $('input#selected_location_id').val($('select#location_id').val());
        $('input#location_id_type').val($('select#location_id').val());
        $('input#location_id_type').data('receipt_printer_type', $('select#location_id').find(':selected').data('receipt_printer_type'));
