$(document).ready( function(){
	...
	$('select#select_location_id').change(function(){
        ...
        $.ajax({
            method: "GET",
            url: "/sells/create-sale/get_inventory_products_sale",
	...
	//Edit mode auto load product by location id
	if($('select#select_location_id').val() != '')
	{
	    $('select#select_location_id').change();
	    $('#auto_load_products').val("0");
	}
            ...
            $.ajax({
                ...
                success: function(result){
					if (result.success) {
						...
						$('.pos_product_div').animate({ scrollTop: $('.pos_product_div').offset().top}, 500, 'linear');
					}
                }
            });
        }
