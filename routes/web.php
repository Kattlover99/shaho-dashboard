...
Route::get('/clear-cache-123', function() {
	...
	echo 'config cache clear....';exit;
    // return what you want
});

Route::get('/clear123', function() {
...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
	...
	Route::get('/sells/create-sale/get_inventory_products_sale', 'SellController@getInventoryProductsSale');
    Route::resource('sells', 'SellController');
	
	Route::get('/expire', 'ExpireController@index')->name('expire_index');
	Route::get('/expire/create', 'ExpireController@create')->name('expire_create');
	Route::post('/expire/store', 'ExpireController@store')->name('expire_store');
	Route::get('/expire/edit/{expireData}', 'ExpireController@edit')->name('expire_edit');
	Route::post('/expire/update/{expireData}', 'ExpireController@update')->name('expire_update');
	Route::get('/expire/delete/{expireData}', 'ExpireController@delete')->name('expire_delete');
    ...
    Route::get('/sells/print_custom/{transaction_id}/{currency}/{header}/{column}', 'SellPosController@print_custom')->name('sell.printInvoice');
